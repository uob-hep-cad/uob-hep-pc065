...
PREFIX=../../../..
#PREFIX=../../../..
ARTWORKDIR=$PREFIX/www/Manufacturing/artwork
...
# copy any ODB++ file
#cp *.tgz $SUBDIR
cp pc065d_fibv2b-i_toplevel_36.tgz $SUBDIR
#
...
cp pc065d_fibv2b-i_placement_body_centre.txt $SUBDIR
#
# Copy the bill of materials
#cp ../bom/*.xls $SUBDIR
# cp ../bom/*.xlsx $SUBDIR
cp ../bom/pc065d_fibv2b-i_bom_newbury.xlsx $SUBDIR
#
